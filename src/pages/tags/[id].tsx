...
export default function Page() {
    ...
    return (
        <>
            <div
                className={`flex justify-center h-36 lg:h-80 w-full bg-${color ? color : "slate-500"
            ...
            <div className="flex justify-center">
                <div
                    className={`rounded-xl p-8 bg-slate-700 w-11/12 border-t-8 border-${color ? color : "slate-500"
                        } shadow-${color ? color : "slate-500"
